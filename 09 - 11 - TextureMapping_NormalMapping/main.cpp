...
int main(void) {
	...
	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // MacOS hack
	glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);

	// enable for debugging view of normal/tangent/bitangent vectors/light source
	...
	glm::mat4 viewMatrix = glm::lookAt(
			glm::vec3(0, 1, 4),    // eye/camera location
  ...
  glfwSetCursorPos(window, width/2, height/2);
	...
	// Load the texture
	GLuint DiffuseTexture = createTexture("textures/bricks_diffuse.jpg");
	GLuint NormalTexture = createTexture("textures/bricks_normal.jpg");
	GLuint SpecularTexture = createTexture("textures/bricks_specular.jpg");
	...
	bool res = loadOBJ("meshes/cylinder.obj", vertices, uvs, normals);
	...
	do {
		...
		ModelMatrix = glm::rotate(ModelMatrix, glm::radians(horizAngle), glm::vec3(0,1,0));
		ModelMatrix = glm::rotate(ModelMatrix, glm::radians(vertAngle), glm::vec3(1,0,0));
		...
		// TODO: define the vertex attributes
...
///*
  GLfloat maxAnisotropicLevel;
  glGetFloatv(GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT, &maxAnisotropicLevel);
  glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAX_ANISOTROPY_EXT, maxAnisotropicLevel);
//*/
